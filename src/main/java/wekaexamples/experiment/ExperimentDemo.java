//
// MODIFIED to use ScavengerCrossValidationResultProducer, rather than CrossValidationResultProducer
//
...
import weka.experiment.ScavengerCrossValidationResultProducer;
...
public class ExperimentDemo {
  ...
  public static void main(String[] args) throws Exception {
    ...
    if (option.equals("crossvalidation")) {
      ScavengerCrossValidationResultProducer cvrp = new ScavengerCrossValidationResultProducer();
	...
	propertyPath[0] = new PropertyNode(
		...
		ScavengerCrossValidationResultProducer.class),
		ScavengerCrossValidationResultProducer.class);
